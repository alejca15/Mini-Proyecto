...
router.put("/", herramientas_controller.put_herramientas); //Edita a los ccategorias
router.delete("/", herramientas_controller.delete_herramientas); //eliminar al categorias
