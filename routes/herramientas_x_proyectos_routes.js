...
router.put("/", Herramientas_x_proyectos.put_herramientas_x_proyectos); //Edita a los ccategorias
router.delete("/", Herramientas_x_proyectos.delete_herramientas_x_proyectos); //eliminar al categorias
