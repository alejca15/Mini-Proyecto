...
router.put("/:id", requisitos_controller.put_requisitos); //Edita a los ccategorias
router.delete("/:id", requisitos_controller.delete_requisitos); //eliminar al categorias
