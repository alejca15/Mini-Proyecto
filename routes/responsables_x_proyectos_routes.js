...
router.put("/", responsable_x_proyecto_controller.put_responsables_x_proyectos); //Edita a los clientes
router.delete("/", responsable_x_proyecto_controller.delete_responsables_x_proyectos); //eliminar al cliente
